...
WHEREAS, the Parties wish to explore a potential business relationship involving the evaluation, testing, and potential implementation of PromptStrike's LLM security monitoring platform ("Guardrail") in Client's production environment;
...
### 1.2 PromptStrike Confidential Information
...
- Implementing and testing the PromptStrike Guardrail system
...
- Never use Client's data for training PromptStrike models
...
Any improvements or modifications to PromptStrike's software made during the evaluation remain PromptStrike's property.
...
Any feedback, suggestions, or ideas provided by Client regarding PromptStrike's products may be used by PromptStrike without obligation.
